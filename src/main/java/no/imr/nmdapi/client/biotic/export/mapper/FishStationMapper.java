...
public class FishStationMapper implements RowMapper<FishStation> {
    ...
    public FishStation mapRow(ResultSet rs, int i) throws SQLException {
        ...
        fishStation.setFishingdepthmin(BigDecimal.valueOf(rs.getDouble("fishing_depth_min")));
        fishStation.setFishingdepthmax(BigDecimal.valueOf(rs.getDouble("fishing_depth_max")));
        ...
        if (rs.getString("id_r_udplist_data_quality") != null) {
            fishStation.setDataquality(newStringDescriptionType(rs.getString("id_r_udplist_data_quality"), null));
        }

        fishStation.setFishingdepthmean(BigDecimal.valueOf(rs.getDouble("fishing_depth_mean")));

        fishStation.setTrawlopening(BigDecimal.valueOf(rs.getDouble("trawl_opening")));
        fishStation.setDoorspread(BigDecimal.valueOf(rs.getDouble("trawl_door_spread")));
        fishStation.setTrawlopeningsd(BigDecimal.valueOf(rs.getDouble("trawl_std_opening")));
        fishStation.setDoorspreadsd(BigDecimal.valueOf(rs.getDouble("trawl_std_door_spread")));
        ...
        fishStation.setTripno(BigInteger.valueOf(rs.getInt("trip_no")));
