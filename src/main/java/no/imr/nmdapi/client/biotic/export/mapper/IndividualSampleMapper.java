...
public class IndividualSampleMapper implements RowMapper<IndividualSample> {
    ...
    public IndividualSample mapRow(ResultSet rs, int i) throws SQLException {
        ...
        if(rs.getString("id_r_udplist_stomach_fill_2") != null){
            individualSample.setStomachfilllab(newStringDescriptionType(rs.getString("id_r_udplist_stomach_fill_2"), null));
        }
